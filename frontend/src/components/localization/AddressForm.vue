...
// Datos estáticos de países europeos
...
// Datos estáticos de provincias españolas
...
export default {
  ...
  methods: {
    async loadCountries() {
      // Usar los datos estáticos en lugar de cargar desde un archivo
      this.countries = EUROPEAN_COUNTRIES;
    },
    ...
    async loadProvinces() {
      ...
      // Usar los datos estáticos en lugar de cargar desde un archivo
      this.provinces = SPANISH_PROVINCES;
    ...
    async loadCities(provinceCode) {
      ...
      // Datos de ejemplo para algunas provincias
      const citiesByProvince = {
        M: [
          // Madrid
          { name: "Madrid", postalCode: "28001" },
          { name: "Alcorcón", postalCode: "28922" },
          { name: "Leganés", postalCode: "28911" },
          { name: "Getafe", postalCode: "28901" },
          { name: "Móstoles", postalCode: "28931" },
        ],
        B: [
          // Barcelona
          { name: "Barcelona", postalCode: "08001" },
          { name: "Hospitalet de Llobregat", postalCode: "08901" },
          { name: "Badalona", postalCode: "08911" },
          { name: "Terrassa", postalCode: "08221" },
          { name: "Sabadell", postalCode: "08201" },
        ],
        V: [
          // Valencia
          { name: "Valencia", postalCode: "46001" },
          { name: "Torrent", postalCode: "46900" },
          { name: "Paterna", postalCode: "46980" },
          { name: "Sagunto", postalCode: "46500" },
          { name: "Gandía", postalCode: "46700" },
        ],
        // Añadir más provincias según sea necesario
      };

      // Usar datos estáticos para la provincia seleccionada o un array vacío si no hay datos
      this.cities = citiesByProvince[provinceCode] || [];
      console.log(
    ...
    // Actualizar formulario desde coordenadas
    ...
    // Procesar resultado de Nominatim
