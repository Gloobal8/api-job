              ...
              <div v-if="isEmployer">
                <v-row>
                  <v-col cols="12" sm="6" md="4">
                    <v-card outlined>
                      <v-card-text class="text-center">
                        <div class="text-h4 font-weight-bold">{{ stats.postedJobs }}</div>
                  ...
                  <v-col cols="12" sm="6" md="4">
                    <v-card outlined>
                      <v-card-text class="text-center">
                        <div class="text-h4 font-weight-bold">{{ stats.activeJobs }}</div>
              ...
              <div v-else>
                <v-row>
                  <v-col cols="12" sm="6" md="4">
                    <v-card outlined>
                      <v-card-text class="text-center">
                        <div class="text-h4 font-weight-bold">{{ stats.appliedJobs }}</div>
                  ...
                  <v-col cols="12" sm="6" md="4">
                    <v-card outlined>
                      <v-card-text class="text-center">
                        <div class="text-h4 font-weight-bold">{{ stats.savedJobs }}</div>
                    ...
                    >
                      <v-card-title class="pb-1">
                        <div class="d-flex align-center">
                          ...
                          <div>
                            <div class="text-subtitle-1 font-weight-bold">{{ job.title }}</div>
                            <div class="text-caption text--secondary">{{ job.company.name }}</div>
                          </div>
                        </div>
                      </v-card-title>
                      ...
                      <v-card-text>
                        ...
                        <div class="d-flex">
                          ...
                          <span class="text-caption">{{ job.salary || 'Negotiable' }}</span>
                        </div>
                      </v-card-text>
                    </v-card>
                  </v-col>
  ...
  data() {
    return {
      ...
      applicationHeaders: [
        ...
        { text: 'Applied On', value: 'createdAt' },
    ...
    dashboardItems() {
      ...
      if (this.isEmployer) {
        items.push(
          ...
          { title: 'Applications', icon: 'mdi-account-search', to: '/applications' },
          { title: 'Company Profile', icon: 'mdi-domain', to: '/company-profile' }
        );
      } else {
        items.push(
          { title: 'My Applications', icon: 'mdi-clipboard-text', to: '/my-applications' },
