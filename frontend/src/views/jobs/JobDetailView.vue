  ...
  <div class="job-detail">
            ...
            <v-card-title class="d-flex align-center">
              ...
              <div>
                ...
                <div class="d-flex align-center">
                  <span class="text-subtitle-1 mr-2">{{ job.company?.name }}</span>
                  <v-chip
                    v-if="job.featured"
                    color="amber"
                    size="small"
                    ...
                    <v-card-text>
                      <v-list dense>
                        ...
                        <v-list-item v-if="job.category">
                          ...
                          <v-list-item-subtitle>{{ job.category }}</v-list-item-subtitle>
                        </v-list-item>
                        ...
                        <v-list-item v-if="job.salary">
                          ...
                          <v-list-item-subtitle>{{ job.salary }}</v-list-item-subtitle>
                        </v-list-item>
                        ...
                        <v-list-item>
                          ...
                          <v-list-item-subtitle>{{ formatDate(job.createdAt) }}</v-list-item-subtitle>
                        </v-list-item>
                        ...
                        <v-list-item v-if="job.deadline">
                          ...
                          <v-list-item-subtitle>{{ formatDate(job.deadline) }}</v-list-item-subtitle>
                        </v-list-item>
                      </v-list>
                    </v-card-text>
                  </v-card>
    ...
    <v-dialog v-model="applyDialog" max-width="600px">
      <v-card>
        ...
        <v-card-text>
          <v-form ref="form" v-model="valid" @submit.prevent="submitApplication">
            <v-text-field
      ...
      setTimeout(() => {
        this.job = {
          ...
          company: {
            ...
            description: "Tech Solutions Inc. is a leading technology company specializing in web and mobile application development, cloud solutions, and digital transformation.",
          },
