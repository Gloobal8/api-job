...
export default {
  ...
  data() {
    return {
      ...
      experienceLevels: [
        { text: "Sin experiencia", value: "entry" },
        { text: "1-2 años", value: "junior" },
        { text: "3-5 años", value: "mid" },
        { text: "5+ años", value: "senior" },
        { text: "10+ años", value: "executive" },
      ],
      sortOptions: [
        { text: "Más recientes", value: "recent" },
        { text: "Salario (mayor a menor)", value: "salary-desc" },
        { text: "Salario (menor a mayor)", value: "salary-asc" },
        { text: "Relevancia", value: "relevance" },
      ],
    };
  },
  created() {
